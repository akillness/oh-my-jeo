...
class CodexProgressTests(unittest.TestCase):
    ...
    def test_summarizes_observable_codex_jsonl_without_raw_or_hidden_text(self) -> None:
        raw = "\n".join(
            [
                ...
                json.dumps({"type": "tool_call", "tool": "apply_patch", "message": "modified src/omj/wrapper/executor_sessions.py"}),
    ...
    def test_oversized_codex_progress_returns_artifact_ref_and_bounded_context(self) -> None:
        ...
        rendered = json.dumps(summary)
        self.assertEqual(summary["raw_output_artifact"]["schema_version"], "omj_context_artifact_ref/v1")
    ...
    def test_codex_progress_emits_event_triggered_updates_without_raw_logs(self) -> None:
        ...
        raw = "\n".join(
            [
                ...
                json.dumps(
                    {
                        "role": "assistant",
                        "content": "Root cause identified in src/omj/wrapper/contract.py: default executor was not propagated.",
                    }
                ),
                json.dumps(
                    {
        ...
        self.assertEqual(summary["latest_progress_event"]["artifact_refs"][0]["schema_version"], "omj_context_artifact_ref/v1")
    ...
    def test_codex_session_observation_exposes_resume_contract_without_execution_claim(self) -> None:
        ...
        self.assertTrue(observation["resume"]["not_omj_backend_execution"])
