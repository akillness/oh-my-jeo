...
load_local_package()
from omj.coding_lifecycle import record_codex_dispatch, record_codex_result, record_codex_verification
from omj.paths import resolve_paths
from omj.runtime_artifacts import summarize_delegated_coding_status, validate_runtime
...
class RuntimeLifecycleInvariantTests(unittest.TestCase):
    ...
    def test_prompt_only_and_runtime_handoff_paths_do_not_create_lifecycle_runs(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertEqual(runtime_handoff["handoff"]["runtime_handoff"]["runtime_profile"]["runtime_family"], "omj")
