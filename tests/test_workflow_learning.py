...
from omj.workflow_learning import (
...
class WorkflowLearningTests(unittest.TestCase):
    ...
    def test_candidate_is_review_only_and_regression_replay_is_deterministic(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertFalse(case["fixture"]["privacy"]["redaction_provable_by_omj"])
    ...
    def test_patch_proposal_regression_snapshot_is_order_stable(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                ...
                ["omj-learning-regression_case:case_a", "omj-learning-regression_case:case_b"],
            )
    ...
    def test_learning_export_bundle_is_metadata_only_and_redacts_fixture_text(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertEqual(written["study_cards"][0]["candidate_refs"], [f"omj-learning-candidate:{candidate['candidate_id']}"])
