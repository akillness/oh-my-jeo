        ...
        with TemporaryDirectory() as tmp:
            ...
            status, stdout, stderr = run_cli(
                ...
                + [
                    ...
                    "--message",
                    "Hermes host reported OMJ plugin loaded.",
                ]
            )
            ...
            self.assertEqual(observation["schema_version"], "omj_plugin_host_observation/v1")
            ...
            self.assertEqual(
                run_cli(
                    ...
                    + [
                        ...
                        "not_observed",
                        "--message",
                        "Host checked the session and did not see OMJ plugin status.",
                    ]
                )[0],
                0,
            )
