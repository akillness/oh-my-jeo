...
load_local_package()
from omj.context_safety import build_coding_progress_reporting_policy, build_progress_event, raw_output_artifact_ref
...
class ContextSafetyTests(unittest.TestCase):
    ...
    def test_progress_event_compacts_raw_payloads_for_chat_context(self) -> None:
        ...
        event = build_progress_event(
            ...
            status="observed",
            severity="warning",
            file_refs=["src/omj/wrapper/contract.py", "src/omj/coding/coding_delegation.py", "x" * 1000],
        ...
        self.assertEqual(event["artifact_refs"][0]["schema_version"], "omj_context_artifact_ref/v1")
