...
_PLAYBOOKS = (
    Playbook(
        ...
        summary="Flagship OMJ path: turn a plain Hermes request into a role-owned next action with an explicit evidence boundary.",
    ...
    Playbook(
        ...
        stages=(
            ...
            PlaybookStage(
                ...
                "hermes",
                "Map Scout to collection, Analyst to synthesis, and Briefer to digest/report output with concrete OMJ skills.",
                "research_department_plan/v1",
        ...
        acceptance_criteria=(
            ...
            "Scout, Analyst, and Briefer lanes are mapped to concrete OMJ skills and source inbox buckets.",
    ...
    Playbook(
        ...
        use_when="A user wants Hermes to guide release operations and monitoring status without OMJ becoming an infrastructure executor.",
        keywords=(
            "deploy-and-monitor",
            "deploy and monitor",
            "deploy monitor",
...
_SURFACE_PLAYBOOKS = (
    ...
    _surface_playbook(
        ...
        "Use when the user wants Hermes or OMJ to learn from a run, improve a skill, patch routing, or prevent the same workflow mistake next time.",
        (
            "workflow-learning",
            "workflow learning",
