...
CAPABILITY_MANIFEST_SCHEMA_VERSION = "omj_capability_manifest/v1"
AGENT_ROLE_CAPABILITY_SCHEMA_VERSION = "agent_role_capability/v1"
SKILL_CAPABILITY_SCHEMA_VERSION = "skill_capability/v1"
HOOK_EVENT_CAPABILITY_SCHEMA_VERSION = "omj_hook_manifest/v1"
...
PREPARED_NOT_OBSERVED = (
    "Prepared OMJ capability, handoff, topology, or routing metadata is not execution, "
