...
def orchestration_patterns() -> list[dict[str, object]]:
    ...
    return [
        ...
        _pattern(
            ...
            "Use when Hermes itself is selected to coordinate OMJ coding skills with optional solo, team, swarm, worker, and worktree guidance.",
