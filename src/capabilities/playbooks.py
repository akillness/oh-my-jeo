...
from ..plugin_bundle.omj.awareness import awareness_primer_payload
from .schema import PLAYBOOK_CAPABILITY_SCHEMA_VERSION, PREPARED_NOT_OBSERVED


PLAYBOOK_WORKFLOW_CONTEXT_RULE = (
    "Use OMJ playbooks as situation-level workflow maps: choose the nearest playbook for the user's request, then route "
