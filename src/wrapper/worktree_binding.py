    ...
    *,
    ...
    return {
        ...
        "worktree": {
            ...
            "exists": path_exists,
            "observed_in_omj_ledger": bool(observed_record),
        ...
        "claim_boundary": (
            ...
            "coding-agent session in an isolated workspace, but OMJ does not launch the executor or claim "
...
def _binding_actions(
    *,
    ...
    disabled_reason = (
        "Worktree path is missing; run omj worktree prepare first."
        if status == "blocked_missing_worktree"
        else ""
    )
        ...
        actions.append(
            {
                ...
                "style": "secondary",
                "backend_command": (
                    f"omj chat session open-executor {shlex.quote(session_id)} --observed "
        ...
        actions.append(
            {
                ...
                "style": "secondary",
                "backend_command": (
                    f"omj runtime observe {target} --runtime-profile {shlex.quote(runtime)} "
