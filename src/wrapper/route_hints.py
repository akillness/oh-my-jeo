...
def build_chat_route_hint_payload(
    ...
    *,
    ...
    payload: dict[str, object] = {
        ...
        "wrapper_contract": {
            "schema_version": "omj_route_hint_wrapper_contract/v1",
            "purpose": "Render a lightweight OMJ hint before generic chat/tools when plugin context is unavailable or a wrapper wants an explicit preview.",
...
def _response_for_hint(
    ...
    *,
    ...
    if primary_hint:
        ...
        headline = f"[omj] {workflow} looks relevant."
        body = (
        ...
        actions = [
            ...
            },
            {
                ...
                "label": "Route for me",
                "enabled": True,
                "backend_command": "omj chat interact",
            },
            {
                "id": "open_picker",
                "label": "Open omj",
        ...
        headline = "[omj] no strong workflow hint yet."
        body = (
            "I do not have a strong OMJ workflow hint from this message alone. "
        ...
        actions = [
            ...
            },
            {
                ...
                "label": "Clarify",
                "enabled": True,
                "backend_command": "omj chat interact --mode clarify",
            },
        ]
    ...
    return {
        ...
        "headline": headline,
        "body": body,
        "visible_prefix": f"[omj] hint:{workflow}" if workflow else "[omj] hint:none",
        "actions": actions,
        "messenger_rendering": {
        ...
        "state": {
            "schema_version": "omj_route_hint_state/v1",
            "selected_workflow": workflow,
            "next_action": next_action,
            "route_hint_count": len(hints),
            "route_hint": {
                "schema_version": "omj_route_hint/v1",
...
def _next_backend_commands(primary_hint: dict[str, object]) -> list[dict[str, object]]:
    ...
    commands = [
        {
            "id": "route_for_me",
            "command": "omj chat interact --source <source> <message>",
            "purpose": "Build the full wrapper interaction envelope from the same event.",
        },
        {
            "id": "open_picker",
            "command": "omj chat interact --source <source> ./omj",
            "purpose": "Open the compact OMJ workflow picker.",
        },
    ]
    if workflow:
        commands.insert(
            ...
            {
                "id": "open_workflow",
                "command": f"omj chat interact --source <source> ./{workflow} <message>",
