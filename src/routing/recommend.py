...
_FALLBACK_SKILLS = ("oh-my-jeo", "plan", "deep-interview")
...
_GUARDRAIL_CANDIDATE_INJECTION_IDS = frozenset(
    {
        ...
        "omj_quality_improvement_loop_before_feedback_triage",
    }
)
_COMMAND_TRIGGER_PHRASES = frozenset(("/", "./", "/o", "./o", "/om", "./om", "/omj", "./omj", "/skills", "./skills"))
