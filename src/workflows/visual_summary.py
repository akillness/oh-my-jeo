...
VISUAL_OBSERVATIONS_INDEX_SCHEMA_VERSION = "omj_visual_observations_index/v1"
...
IMAGE_GENERATION_SETUP_OPTIONS = (
    {
        ...
        "description": "Use an already available GPT/OpenAI-style image generator outside OMJ.",
    },
    {
...
_POSTER_ARCHETYPE_PROFILES = {
    ...
    "editorial_magazine": {
        ...
        "background_behavior": "let the scene feel published and curated while preserving the OMJ evidence footer and modules",
    ...
    "constructivist_photomontage": {
        ...
        "composition_principle": "activate diagonals and overlapping shapes while keeping each OMJ content module readable",
...
_DEFAULT_VISUAL_MARK = "OMJ generated"
...
_DOMAIN_PROFILES = {
    ...
    "operations": {
        ...
        "palette": "neutral paper, deep ink, OMJ blue, soft teal, quiet gold",
    ...
    *,
    ...
    record = {
        ...
        "layout": {
            ...
            "composition_rule": (
                "Preserve source label, headline, readable section modules, evidence footer, and a small OMJ generated mark; "
...
def write_visual_observation(paths: OmjPaths, record: dict[str, Any]) -> dict[str, Any]:
    errors = validate_visual_observation(record)
    if errors:
        raise ValueError("; ".join(errors))
...
def list_visual_observations(paths: OmjPaths, *, card_id: str | None = None) -> list[dict[str, Any]]:
...
def _public_domain_profile(domain_key: str, profile: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "avoid_style": _PREMIUM_AVOID_STYLE,
        "format_contract": (
            "OMJ format contract: keep source badge, headline, content modules, evidence footer, and small 'OMJ generated' mark stable; "
...
def _generation_prompt(
    ...
    return (
        ...
        "Preserve the OMJ img-summary format contract: source/category badge, headline, source-kind subtitle, "
        "readable numbered or grouped content modules, evidence footer, and a small quiet label that reads exactly 'OMJ generated' "
...
def _observation_path(paths: OmjPaths, observation_id: str) -> Path:
...
def _write_observations_index(paths: OmjPaths) -> None:
