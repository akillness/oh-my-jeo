...
class OmjPaths:
    ...
    def skills_dir(self) -> Path:
        return self.omj_home / "skills"

    @property
    def manifest_path(self) -> Path:
        return self.omj_home / "manifest.json"

    @property
    def runtime_dir(self) -> Path:
        return self.omj_home / "runtime"
    ...
    def operations_dir(self) -> Path:
        return self.omj_home / "operations"
    ...
    def hermes_ops_dir(self) -> Path:
        return self.omj_home / "hermes-ops"
    ...
    def research_department_dir(self) -> Path:
        return self.omj_home / "research-department"
    ...
    def agent_operator_productivity_dir(self) -> Path:
        return self.omj_home / "agent-ops"
    ...
    def materials_dir(self) -> Path:
        return self.omj_home / "materials"
    ...
    def goals_dir(self) -> Path:
        return self.omj_home / "goals"

    @property
    def loops_dir(self) -> Path:
        return self.omj_home / "loops"

    @property
    def setup_profile_path(self) -> Path:
        return self.omj_home / "setup-profile.json"
    ...
    def target_registry_path(self) -> Path:
        return self.omj_home / "targets.json"

    @property
    def workflow_state_dir(self) -> Path:
        return self.omj_home / "state"

    @property
    def learning_dir(self) -> Path:
        return self.omj_home / "learning"
    ...
    def use_cases_dir(self) -> Path:
        return self.omj_home / "use-cases"
    ...
    def hermes_plugin_dir(self) -> Path:
        return self.hermes_plugins_dir / "omj"
    ...
    def team_profile_manifest_dir(self) -> Path:
        return self.omj_home / "team-profile-packs"
...
def default_omj_home() -> Path:
    return expand_path(os.environ.get("OMJ_HOME", "~/.omj"))
...
def project_omj_home(cwd: str | Path | None = None) -> Path:
    return expand_path(cwd or Path.cwd()) / ".omj"
...
def resolve_paths(
    ...
    *,
    ...
    default_omj = project_omj_home() if normalized_scope == "project" else default_omj_home()
    default_hermes = project_hermes_home() if normalized_scope == "project" else default_hermes_home()
    return OmjPaths(
        omj_home=expand_path(omj_home) if omj_home else default_omj,
