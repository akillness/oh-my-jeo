...
def _add_menubar_commands(sub) -> None:
    menubar = sub.add_parser("menubar", help="Install or inspect the OMJ menu bar helper.")
    ...
    install = menubar_sub.add_parser("install", help="Install and start the native macOS OMJ menu bar helper when supported.")
    ...
    start = menubar_sub.add_parser("start", help="Start the installed OMJ menu bar helper.")
    start.set_defaults(func=cmd_menubar_start)

    stop = menubar_sub.add_parser("stop", help="Stop the OMJ menu bar helper LaunchAgent.")
    stop.set_defaults(func=cmd_menubar_stop)

    uninstall = menubar_sub.add_parser("uninstall", help="Stop and remove the OMJ menu bar helper.")
