...
OMJ_DESCRIPTION_PREFIX = "[omj] "


def omj_description(description: str) -> str:
    text = description.strip()
    if text.lower().startswith(OMJ_DESCRIPTION_PREFIX):
        return text
    return f"{OMJ_DESCRIPTION_PREFIX}{text}"
...
def canonical_hermes_role(name: str, category: str, requested: str) -> str:
    """Return the user-facing OMJ responsibility role for a skill."""
...
class SkillDefinition:
    ...
    def __post_init__(self) -> None:
        object.__setattr__(self, "description", omj_description(self.description))
    ...
    *,
    ...
    return SkillDefinition(
        ...
        why_this_exists=(
            ...
            "evidence-bounded OMJ operating surface instead of ad hoc narration."
        ),
        do_not_use_when=(
...
_DEFINITIONS = [
    SkillDefinition(
        ...
        why_this_exists="`oh-my-jeo` exists to keep Hermes chat routing conservative: it maps plain requests to the right workflow, explains evidence boundaries, and avoids making every keyword look like hidden implementation.",
        do_not_use_when=(
    ...
    SkillDefinition(
        ...
        phase="durable-goals",
        hermes_role="runtime-handoff-guidance",
        handoff_policy="Use Hermes to maintain .omj/goals goal_ledger/v1 state, show goal_status_card/v1 / goal_continuation/v1 next actions, and route coding milestones to the selected runtime profile with only observed runtime evidence.",
        ...
        artifact_expectations=("metadata-only .omj/goals ledger", "goal_status_card/v1 or goal_continuation/v1 wrapper payload", "runtime run record only for explicitly linked coding milestones"),
    ...
    SkillDefinition(
        ...
        artifact_expectations=("source_finder_plan/v1 under .omj/source-finder when a wrapper or CLI records it",),
        safety_rules=(
        ...
        why_this_exists=(
            ...
            "and downstream workflow choice without pretending OMJ searched, downloaded, or verified the material."
        ),
        do_not_use_when=(
    ...
    SkillDefinition(
        ...
        artifact_expectations=("research_department_plan/v1 under .omj/research-department/plans when a wrapper or CLI records it",),
        safety_rules=(
        ...
        why_this_exists=(
            ...
            "profiles, cron, knowledge storage, synthesis tooling, and delivery glue, while OMJ keeps every runtime claim observed-only."
        ),
        do_not_use_when=(
    ...
    SkillDefinition(
        ...
        artifact_expectations=("paper_learning_card/v1 under .omj/paper-learning when a wrapper or CLI records it",),
        safety_rules=(
    ...
    SkillDefinition(
        ...
        artifact_expectations=("operation_artifact/v1 under .omj/operations when a wrapper or CLI records it",),
        safety_rules=(
    ...
    SkillDefinition(
        ...
        artifact_expectations=("material_artifact/v1 under .omj/materials when a wrapper or CLI records it",),
        safety_rules=(
    ...
    SkillDefinition(
        ...
        artifact_expectations=("hermes_ops_blueprint/v1 under .omj/hermes-ops/blueprints when a wrapper or CLI records it",),
        safety_rules=(
        ...
        why_this_exists=(
            ...
            "without OMJ becoming a hidden cron runner, transport bot, source retriever, or executor."
        ),
        do_not_use_when=(
    ...
    SkillDefinition(
        "doctor",
        "Hermes adaptation for diagnosing oh-my-jeo installation health.",
        ("doctor", "$doctor", "diagnose omj", "installation health"),
        ...
        required_inputs=("omj home", "Hermes home", "observed issue"),
...
_FEATURE_SURFACE_SKILLS = (
    ...
    _feature_surface_skill(
        ...
        good_prompt="workflow-learning record that Hermes did not use OMJ here and create a missed-route review bundle.",
...
_HARNESSES = [
    HarnessDefinition(
        ...
        "Record prepared coding delegation with omj coding delegate; record observed execution only when Hermes exposes a separate coding, review, or verification lane.",
        "metadata_only",
        quality_tier="handoff-gated",
        quality_bar=(
    ...
    HarnessDefinition(
        ...
        "Use when Hermes should turn supplied source or structured card fields into a provider-neutral image-generation prompt card with an appropriate format profile, domain theme, poster archetype, premium background plate/texture/camera direction, and stable OMJ generated mark.",
