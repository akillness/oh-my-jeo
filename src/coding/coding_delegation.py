...
_LOCAL_CAPABILITY_EXAMPLES = {
    ...
    "hermes": [
        ...
        "Hermes delegation",
        "OMJ ultrawork/team/ultraqa/code-review",
    ],
    "generic": [
...
def coding_delegation_record_payload(
    ...
    *,
    ...
    record: dict[str, object] = {
        ...
        "recommended_workflow": delegation.get("recommended_workflow", "oh-my-jeo"),
    ...
    *,
    ...
    return {
        ...
        "codex_invocation": {
            ...
            "wrapper_note": "Replace {message} only at dispatch time; do not persist the raw task in OMJ artifacts.",
        },
        "executor_local_capability_strategy": _executor_local_capability_strategy("codex"),
        "status": "prepared_not_observed",
        "recording_contract": "prepared_not_observed",
        "dispatch_contract": "wrapper_dispatches_to_codex; omj_does_not_execute_codex",
        ...
        "scope": [
            ...
            "Respect the recommended OMJ workflow and harness metadata.",
        ...
        "non_goals": [
            ...
            "Do not call network services from omj while preparing this handoff.",
        ],
    ...
    *,
    ...
    return {
        ...
        "scope": [
            ...
            "Keep OMJ wrapper/session state separate from executor evidence.",
        ],
        "non_goals": [
            "Do not claim OMJ or Hermes dispatched the prompt.",
...
def _runtime_handoff(
    ...
    *,
    ...
    handoff: dict[str, object] = {
        ...
        "dispatch_contract": "wrapper_or_user_starts_runtime; omj_does_not_execute_runtime",
        "executor_readiness": executor_readiness_contract(profile),
        "executor_local_capability_strategy": _executor_local_capability_strategy(profile),
        ...
        "observation_contract": {
            ...
            "record_with": (
                "omj runtime observe --session <wrapper-session-id> --runtime-profile "
        ...
        "scope": [
            ...
            f"Run {label} with the recommended OMJ workflow unless local runtime routing has stronger evidence.",
            "For Hermes-owned coding, use OMJ coding skills directly instead of pretending a separate executor ran.",
        ...
        "non_goals": [
            "Do not claim OMJ started the runtime.",
...
def _local_capability_fallback(profile: str) -> str:
    ...
    return (
        ...
        f"the OMJ task, harness, acceptance criteria, verification, and evidence contract as a {label} task."
    )
...
def _codex_prompt_template(delegation: CodingDelegation, *, codex_skill: str) -> str:
    return (
        ...
        "Recommended OMJ workflow: `{workflow}`\n"
        ...
        "- Do not claim OMJ observed local capability availability, dispatch, implementation, review, CI, or merge.\n\n"
        "Rules:\n"
...
def _prompt_only_template(delegation: CodingDelegation, *, profile: str, label: str) -> str:
    return (
        ...
        "- Do not claim OMJ observed capability availability or execution.\n\n"
        "Rules:\n"
...
def _runtime_prompt_template(delegation: CodingDelegation, *, profile: str, label: str) -> str:
    return (
        ...
        "- For Hermes runtime, installed Hermes/OMJ skills may be relevant.\n"
        ...
        "Runtime rules:\n"
        "- Treat this as a runtime contract prepared by Hermes/OMJ, not as observed execution.\n"
...
def _codex_skill_for_workflow(workflow: str) -> str:
    name = workflow.strip() or "oh-my-jeo"
...
def _delegation_prompt_template(action: str, intent: str, workflow: str, harness: str) -> str:
    if action == "fallback":
        return (
            "Use the `oh-my-jeo` router before coding delegation.\n\n"
