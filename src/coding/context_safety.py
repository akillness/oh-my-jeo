...
CONTEXT_ARTIFACT_REF_SCHEMA_VERSION = "omj_context_artifact_ref/v1"
PROGRESS_EVENT_SCHEMA_VERSION = "omj_progress_event/v1"
...
def context_budget_payload() -> dict[str, object]:
    return {
        "schema_version": "omj_context_budget/v1",
