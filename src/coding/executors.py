...
RUNTIME_PROFILE_DETAILS = {
    "hermes": {
        ...
        "dispatch_text_template": "Use the selected OMJ coding skill for: {message}",
        "recommended_for": "Hermes-owned coding using OMJ skills, team/swarm guidance, tmux-style workers, worker protocol, and worktree discipline",
        "templates": (
            {
                "label": "Hermes solo coding skill",
                "syntax": "Hermes skill",
                "command_template": "Use OMJ ultrawork for: {message}",
                "when_to_use": "Use when the operator wants Hermes itself to own one bounded coding task with OMJ guardrails.",
                "observed_event": "runtime_start",
            },
            {
                "label": "Hermes durable goal loop",
                "syntax": "Hermes skill",
                "command_template": "Use OMJ ultragoal for: {message}",
            ...
            },
            {
                ...
                "syntax": "Hermes skill",
                "command_template": "Use OMJ team for: {message}",
            ...
            },
            {
                ...
                "syntax": "Hermes skill",
                "command_template": "Use OMJ code-review for: {message}",
...
def public_executor_options() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "work_owner_mode": "prompt_only_handoff",
            "dispatchable": False,
            "recommended_for": "portable prompt handoff for an executor OMJ does not directly know",
        },
        {
            "profile": "hermes",
            "label": "Hermes coding skill runtime",
...
def prompt_invocation_for_profile(profile: str) -> dict[str, str]:
    ...
    return {
        ...
        "wrapper_note": "Copy or pass this prompt only when the user chooses that executor; OMJ does not dispatch it.",
    }
...
def runtime_invocation_for_profile(profile: str) -> dict[str, str]:
    ...
    return {
        ...
        "message_placeholder": "{message}",
        "wrapper_note": (
            "Start this runtime only after the user or wrapper chooses it; OMJ records the prepared runtime contract, "
...
def hermes_coding_team_path_contract(profile: str) -> dict[str, object]:
    ...
    return {
        ...
        "purpose": (
            "Let Hermes own coding through selected OMJ coding skills, solo/team/swarm guidance, "
        ...
        "start_modes": [
            {
                ...
                "entrypoint": "Use OMJ ultrawork for: {message}",
            ...
            },
            {
                ...
                "entrypoint": "Use OMJ ultragoal for: {message}",
                "first_observed_event": "runtime_start",
            },
            {
                "id": "team",
                ...
                "entrypoint": "Use OMJ team for: {message}",
