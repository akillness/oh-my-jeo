...
def read_plugin_host_observations(paths: OmjPaths, *, limit: int | None = 20) -> tuple[list[dict[str, Any]], list[str]]:
...
def latest_plugin_host_observation(paths: OmjPaths) -> tuple[dict[str, Any] | None, list[str]]:
    records, errors = read_jsonl_objects(paths.runtime_plugin_host_observations_path)
...
def _append_plugin_host_observation(paths: OmjPaths, record: dict[str, Any]) -> None:
