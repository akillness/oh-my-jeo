...
CODEGRAPH_SCHEMA_VERSION = "omj_codegraph/v1"
CODEGRAPH_CONTEXT_SCHEMA_VERSION = "omj_codegraph_context/v1"
CODEGRAPH_SUMMARY_SCHEMA_VERSION = "omj_codegraph_summary/v1"
CODEGRAPH_ARTIFACT_RELATIVE_PATH = Path(".omj") / "codegraph" / "codegraph.json"
CLAIM_BOUNDARY = (
