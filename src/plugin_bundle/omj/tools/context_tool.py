...
OMJ_CONTEXT_SCHEMA = {
    "name": "omj_context",
    "description": (
        "Return compact OMJ operating context for Hermes before generic chat, image, file, search, or coding tools. "
...
def omj_context_handler(args: dict, **kwargs) -> str:
    observation = observe_plugin_tool_call("omj_context", args, kwargs)
    ...
    payload["plugin_tool"] = "omj_context"
...
def _context_brief(
    ...
    *,
    ...
    try:
        from omj.context import build_context_brief as build_package_context_brief
    except Exception:
