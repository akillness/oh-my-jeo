---
name: deep-interview
description: [omj] Hermes Deep Interview workflow: one-question-at-a-time clarification.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, clarification]
...
```sh
omj runtime record --skill deep-interview --harness deep-interview --status started
