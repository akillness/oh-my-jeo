---
name: meeting-brief
description: [omj] Hermes Meeting Brief workflow: agenda, prompts, decisions, and record template.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, meeting]
    category: meeting
    phase: preparation
    role: operator
...
```sh
omj runtime record --skill meeting-brief --harness meeting-facilitation --status started
