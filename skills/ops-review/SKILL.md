---
name: ops-review
description: [omj] Hermes Ops Review workflow: status, risks, blockers, priorities, and follow-ups.
metadata:
  hermes:
...
```sh
omj runtime record --skill ops-review --harness ops-review --status started
