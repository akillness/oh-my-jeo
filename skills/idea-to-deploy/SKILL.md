---
name: idea-to-deploy
description: [omj] Hermes Idea-to-Deploy workflow: shape an app idea into decisions, delivery handoff, verification, release, and monitoring status.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, delivery]
    category: delivery
...
```sh
omj runtime record --skill idea-to-deploy --harness app-delivery-loop --status started
