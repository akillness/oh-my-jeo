---
name: report-package
description: [omj] Hermes Report Package workflow: weekly/monthly reports, executive briefs, PPT-ready outlines, and upload packages.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, reporting]
    category: reporting
...
```sh
omj runtime record --skill report-package --harness report-package --status started
