...
description: [omj] Hermes Feedback Triage workflow: cluster customer signals and choose the next workflow.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, triage]
    category: triage
    phase: feedback
    role: operator
...
```sh
omj runtime record --skill feedback-triage --harness customer-insight-triage --status started
