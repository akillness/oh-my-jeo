---
name: wiki
description: [omj] Hermes adaptation for maintaining a project-local markdown wiki.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, knowledge]
    category: knowledge
    phase: capture
    role: memory-keeper
...
```sh
omj runtime record --skill wiki --harness docs-specialist --status started
