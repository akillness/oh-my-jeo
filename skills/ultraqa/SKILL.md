---
name: ultraqa
description: [omj] Hermes UltraQA workflow: adversarial QA and fix loops.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, verification]
...
```sh
omj runtime record --skill ultraqa --harness qa-specialist --status started
