---
name: img-summary
description: [omj] Hermes img-summary workflow: turn meetings, reports, PRs, issues, research, and release notes into source-specific, domain-aware, poster-archetype-aware image-generation-ready visual prompt cards.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, materials]
    category: materials
...
```sh
omj runtime record --skill img-summary --harness img-summary --status started
