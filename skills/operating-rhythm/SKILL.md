...
description: [omj] Hermes Operating Rhythm workflow: meeting minutes, scrum/sprint records, retros, decisions, and follow-up history.
metadata:
  hermes:
...
```sh
omj runtime record --skill operating-rhythm --harness operating-rhythm --status started
