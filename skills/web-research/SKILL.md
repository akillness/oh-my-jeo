---
name: web-research
description: [omj] Hermes Web Research workflow: source-backed current information gathering.
metadata:
  hermes:
...
```sh
omj runtime record --skill web-research --harness research --status started
