---
name: research-brief
description: [omj] Hermes Research Brief workflow: source-backed business research without pretending evidence was fetched.
metadata:
  hermes:
...
```sh
omj runtime record --skill research-brief --harness business-research --status started
