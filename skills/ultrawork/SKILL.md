---
name: ultrawork
description: [omj] Hermes Ultrawork compatibility workflow: bounded parallel delivery guidance.
metadata:
  hermes:
...
```sh
omj runtime record --skill ultrawork --harness goal-execution --status started
