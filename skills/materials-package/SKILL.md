...
description: [omj] Hermes Materials Package workflow: decks, PDFs, spreadsheets, documents, HWP, Markdown, and binary export handoffs.
metadata:
  hermes:
...
```sh
omj runtime record --skill materials-package --harness materials-package --status started
