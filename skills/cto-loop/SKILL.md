---
name: cto-loop
description: [omj] Hermes CTO Loop workflow: roadmap, PM, technical tradeoffs, risk, delivery, release, and follow-up operating cadence.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, leadership]
    category: leadership
...
```sh
omj runtime record --skill cto-loop --harness app-delivery-loop --status started
