---
name: strategy-brief
description: [omj] Hermes Strategy Brief workflow: options, tradeoffs, recommendation, and decision notes.
metadata:
  hermes:
    tags: [workflow, oh-my-jeo, strategy]
    category: strategy
    phase: brief
    role: operator
...
```sh
omj runtime record --skill strategy-brief --harness strategy-synthesis --status started
