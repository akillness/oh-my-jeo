...
description: [omj] Hermes adaptation for bounded official/upstream best-practice research.
metadata:
  hermes:
...
```sh
omj runtime record --skill best-practice-research --harness research --status started
