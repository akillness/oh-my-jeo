...
description: [omj] Hermes adaptation for measurable performance-goal execution.
metadata:
  hermes:
...
```sh
omj runtime record --skill performance-goal --harness goal-execution --status started
