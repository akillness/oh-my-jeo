---
name: ralph
description: [omj] Hermes Ralph workflow: persistent execution with verification and review.
metadata:
  hermes:
...
```sh
omj runtime record --skill ralph --harness goal-execution --status started
